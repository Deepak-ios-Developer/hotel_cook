...
class AuthViewModel extends ChangeNotifier {
  ...
  List<UserModel> users = [
    ...
    UserModel(id: '5', name: 'Jack Jackson restaurant', role: 'Business Owner'),
    UserModel(id: '6', name: 'Jack Jackson restaurant', role: 'Business Owner'),
    UserModel(id: '7', name: 'Jack Jackson restaurant', role: 'Business Owner'),
    UserModel(id: '8', name: 'Jack Jackson restaurant', role: 'Business Owner'),
  ];
